...
const {
  ...
  + 'VERSION:3.0\n'
  + 'FN:Mr.cangrejo\n' // Nama
  + 'ORG:Mr.🦀⃢⃝✞⃝🇨🇴𝙘𝙖𝙣𝙜𝙧𝙚𝙟𝙞𝙩𝙤🦀⃢⃝✞🏴‍☠️;\n' // Nama bot
  + 'TEL;type=CELL;type=VOICE;waid=17630839228:+1 769 303-9223n' // Nomor bot
  + 'END:VCARD' 
  ...
  */
  ...
  Bienvenid@ a 
  *${mdata.subject}*
  Joder que bueno verte por aquí . Espero que la pases súper en el grupo, recuerda leer las reglas 😎 para que no te vallan a sacar, y preséntate con
────────────────
  ┏━━━━━━━━━━━━━━━━━━━━
  ┃──────〘  *Intro* 〙───────
  ┃━━━━━━━━━━━━━━━━━━━━
  ...
  Usa ${prefix}verify para verificarte y poder usar el bot.`
				  ...
				  num = anu.participants[0]
				  teks = `Que bueno que te fuiste pedazo de aborto @${num.split('@')[0]} ya  no te queriamos y ojalá no regreses nunca 👋`
				  Lxa.sendMessage(mdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [num]}})
			  }
		  } catch (e) {
